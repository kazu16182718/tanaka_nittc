...
mkdir dict
cd dict
python3 /home/pi/sh_file/replace.py /home/pi/julius/dict/dic.txt 
...
# .grammerファイルを作成
python3 /home/pi/set_file/preparation/py/gram.py
python3 /home/pi/set_file/preparation/py/voca.py
# 独自辞書データに変換
